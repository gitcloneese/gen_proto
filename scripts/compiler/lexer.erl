-file("/usr/local/Cellar/erlang@20/20.3.8.22_1/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang@20/20.3.8.22_1/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 14).
...
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 90 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
-file("/usr/local/Cellar/erlang@20/20.3.8.22_1/lib/erlang/lib/parsetools-2.1.6/include/leexinc.hrl", 313).
